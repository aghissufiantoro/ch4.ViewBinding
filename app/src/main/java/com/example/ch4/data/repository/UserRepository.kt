package com.example.ch4.data.repository

import android.net.Uri
import com.example.ch4.auth.FirebaseAuthDataSource
import com.example.ch4.model.toUser
import com.example.ch4.utils.ResultWrapper
import com.example.ch4.utils.proceedFlow
...
interface UserRepository{
    ...
    fun getCurrentUser(): com.example.ch4.model.User?
...
class UserRepositoryImpl(private val dataSource: FirebaseAuthDataSource) : UserRepository {
    ...
    override fun getCurrentUser(): com.example.ch4.model.User? {
