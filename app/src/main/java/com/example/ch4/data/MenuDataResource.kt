...
import com.example.ch4.model.DetailMenu
...
class MenuDataSourceImpl() : MenuDataSource{
    override fun getDetailMenu(): List<DetailMenu> = listOf(
        ...
        DetailMenu(
            ...
            name = "Burger",
            price = "Rp. 15.000",
            imgUrl = "https://github.com/aghissufiantoro/ResourceBinar/blob/main/foodiesfeed.com_cappuccino-with-croissant.jpg",
        ...
        DetailMenu(
            ...
            name = "Ayam Goyeng",
            price = "Rp 20.000",
            imgUrl = "https://github.com/aghissufiantoro/ResourceBinar/blob/main/foodiesfeed.com_chinese-steamed-and-fried-dim-sum-in-wooden-steamers.jpg",
